...
<body>
    ...
    <div class="container-fluid ">
        ...
        <div class="d-flex justify-content-center">
            <div class="card col-md-8 mb-4 mt-4">
                <div class="row no-gutters">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center shadow p-3 bg-light rounded h5">
                                <a href="<?= $ElementArticle->link ?>" target="_blank">Lien vers l'article</a>
                            </div>
                        </div>
                    </div>
                </div>
